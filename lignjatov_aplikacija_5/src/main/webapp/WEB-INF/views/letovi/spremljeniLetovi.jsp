...
${greska}
	...
	<form method="get">
		Icao: <input type="text" name="icao" /> <br /> Datum od(dd.mm.yyyy):
		<input type="text" name="datumOd" /> <br />Datum do(dd.mm.yyyy): <input
			type="text" name="datumDo" /> <br /> <input type="submit"
	...
	<form method="get">
		...
		<input type="hidden" name="datumOd"
			value="<%=request.getParameter("datumOd")%>"> <input
			type="hidden" name="datumDo"
			value="<%=request.getParameter("datumDo")%>">
	</form>
	<form method=get>
